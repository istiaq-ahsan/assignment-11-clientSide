...
const SixMarathonCard = ({ marathon }) => {
  ...
  return (
    <div
      className="card bg-green-100 shadow-xl border border-gray-300 hover:scale-[1.05] transition-all
        h-auto  mx-auto"
    >
      <div className="h-[50%] p-3">
        <figure>
          <img
            className="md:h-[150px] lg:h-[180px] w-full rounded-xl"
      ...
      <div className="card-body">
        ...
        <div className="card-actions">
          <Link to={`/marathonDetails/${_id}`} className="btn btn-neutral">
            See More
          </Link>
        </div>
      </div>
